...
def combK(latency: int, k: int, W_base: int, Pd_one) -> float:
    ...
    def integrand_totalComb(start):
        ...
        diff = min(L_max, max(0,start_comb))
        L_min = L_max-diff
...
for n_chunk in n_chunk_list:
    for sla_prob in sla_prob_list:
        for latency in latency_list:
            ...
            out_file_name = f"./[Nihao AE] Final Result/Nihao AE Results/AE_nihao_{sla_prob}_{latency/1000}s_log.txt"
